...
;// ./src/vibe-video-cut/utils/fileResolver.ts
...
function createFileResolver(files) {
  return new FileResolver(files);
}

;// ./src/vibe-video-cut/components/useAnimeTimeline.tsx
...
const ElementRenderer = ({ element, frame, fps, fileResolver }) => {
...
const PageRenderer = ({ page, frame, fps, fileResolver }) => {
