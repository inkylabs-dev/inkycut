...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "opensaas:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkopensaas"] = self["webpackChunkopensaas"] || [];
...
;// ./src/vibe-video-cut/components/ResizeHandle.tsx



const HANDLE_SIZE = 8;
const ResizeHandle = ({ type, setItem, item }) => {
  const scale = (0,esm.useCurrentScale)();
  const size = Math.round(HANDLE_SIZE / scale);
  const borderSize = 1 / scale;
  const sizeStyle = (0,react.useMemo)(() => {
    return {
      position: "absolute",
      height: size,
      width: size,
  ...
  return /* @__PURE__ */ react.createElement("div", { onPointerDown, style });
};

;// ./src/vibe-video-cut/components/SelectionOutline.tsx




const SelectionOutline = ({ compositionElement, changeCompositionElement, setSelectedElement, selectedElement, isDragging }) => {
  const scale = (0,esm.useCurrentScale)();
  ...
  const style = (0,react.useMemo)(() => {
    return {
      ...
      position: "absolute",
      outline: isSelected ? `${scaledBorder * 2}px solid #FF3366` : hovered && !isDragging ? `${scaledBorder}px solid #0B84F3` : void 0,
      boxShadow: isSelected ? "0 0 0 2px rgba(255, 51, 102, 0.5)" : void 0,
      backgroundColor: isSelected ? "rgba(255, 51, 102, 0.1)" : void 0,
      userSelect: "none",
      touchAction: "none",
      pointerEvents: "all",
      // Ensure we can interact with this element
      zIndex: isSelected ? 1e3 : void 0
      // Bring selected elements to front
    };
  }, [compositionElement, hovered, isDragging, isSelected, scaledBorder]);
  const startDragging = (0,react.useCallback)(
    (e) => {
      const initialX = e.clientX;
      const initialY = e.clientY;
      const onPointerMove = (pointerMoveEvent) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    isSelected ? /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(ResizeHandle, { item: compositionElement, setItem: changeCompositionElement, type: "top-left" }), /* @__PURE__ */ react.createElement(ResizeHandle, { item: compositionElement, setItem: changeCompositionElement, type: "top-right" }), /* @__PURE__ */ react.createElement(ResizeHandle, { item: compositionElement, setItem: changeCompositionElement, type: "bottom-left" }), /* @__PURE__ */ react.createElement(ResizeHandle, { item: compositionElement, setItem: changeCompositionElement, type: "bottom-right" })) : null
  );
};

;// ./src/vibe-video-cut/components/SortedOutline.tsx




const displaySelectedItemOnTop = (items, selectedItem) => {
...
const SortedOutlines = ({ items, selectedItem, changeItem, setSelectedItem }) => {
  ...
  return itemsToDisplay.map((item) => {
    ...
    return /* @__PURE__ */ react.createElement(esm.Sequence, { key: item.id, ...sequenceProps }, /* @__PURE__ */ react.createElement(
      SelectionOutline,
      {
...
;// ./src/vibe-video-cut/components/Layer.tsx



const Layer_Layer = ({ element, frame, fps, children }) => {
...
;// ./src/vibe-video-cut/components/Composition.tsx
...
const ElementRenderer = ({ element, frame, fps }) => {
  ...
  switch (elementWithId.type) {
    case "image":
      return elementWithId.src ? /* @__PURE__ */ react.createElement(
        esm.Img,
        {
...
const PageRenderer = ({ page, frame, fps }) => {
  ...
  return /* @__PURE__ */ React.createElement(AbsoluteFill, { style: { backgroundColor: page.backgroundColor || "#ffffff" } }, elementsWithIds.map((element, index) => /* @__PURE__ */ React.createElement(
    Layer,
    {
...
const MainComposition = ({
  ...
  if (currentPageIndex !== void 0) {
    ...
    return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: outer, onPointerDown }, /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: layerContainer }, elementsWithIds.map((element) => /* @__PURE__ */ react.createElement(
      Layer_Layer,
      {
        key: `element-${element.id}`,
        element,
    ...
    ))), setSelectedItem && changeItem && /* @__PURE__ */ react.createElement(
      SortedOutlines,
      {
        selectedItem,
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: outer, onPointerDown }, data.pages.map((page, index) => {
  ...
  }), currentPageIndex !== void 0 && setSelectedItem && changeItem && data.pages[currentPageIndex] && /* @__PURE__ */ react.createElement(
    SortedOutlines,
    {
      selectedItem,
...
;// ./src/vibe-video-cut/components/types.ts
...
;// ./src/vibe-video-cut/components/remotionEntrypoint.tsx
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 569).then(__webpack_require__.bind(__webpack_require__, 569)).then(({ StudioInternals }) => {
