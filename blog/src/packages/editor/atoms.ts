...
import type { CompositionData, CompositionElement, CompositionPage, Project, ChatMessage, AppState, LocalFile } from '../composition/types';
import { 
  createFileStorage, 
  getStorageModeForProject, 
  migrateFiles 
} from './utils/fileStorage';
import type { IFileStorage } from './utils/fileStorage';
