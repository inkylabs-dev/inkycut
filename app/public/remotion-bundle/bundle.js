...
var Scheduler = __webpack_require__(8295),
  React = __webpack_require__(3169),
  ReactDOM = __webpack_require__(4672);
...
if (true) {
  ...
  checkDCE();
  module.exports = __webpack_require__(9366);
} else {}
...
if (true) {
  ...
  // DevTools can report bad minification during injection.
  checkDCE();
  module.exports = __webpack_require__(9870);
} else {}
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3169);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4672);
...
const remotion_1 = __webpack_require__(3332);
...
// NAMESPACE OBJECT: ./src/Composition.tsx
var Composition_namespaceObject = {};
__webpack_require__.r(Composition_namespaceObject);

// EXTERNAL MODULE: ../render/node_modules/remotion/dist/esm/index.mjs
var esm = __webpack_require__(3332);
// EXTERNAL MODULE: ../render/node_modules/react/index.js
var react = __webpack_require__(3169);
;// ./src/Layer.tsx



const Layer_Layer = (props) => {
...
;// ./src/useAnimeTimeline.tsx



const useAnimeTimeline_useAnimeTimeline = (animeTimelineFactory, deps) => {
...
const MainComposition = ({
  ...
  const fileResolver = React.useMemo(() => {
    return files ? createFileResolver(files) : void 0;
  }, [files]);
  const outer = {};
  if (currentPageIndex !== void 0) {
    const currentPage = data.pages[currentPageIndex];
    if (!currentPage) {
      return /* @__PURE__ */ React.createElement(AbsoluteFill, { style: { backgroundColor: "#000000" } }, /* @__PURE__ */ React.createElement("div", { style: {
        color: "white",
        fontSize: 24,
        display: "flex",
        alignItems: "center",
    ...
    return /* @__PURE__ */ React.createElement(AbsoluteFill, { style: outer }, /* @__PURE__ */ React.createElement(AbsoluteFill, { style: layerContainer }, elementsWithIds.map((element) => /* @__PURE__ */ React.createElement(
      Layer,
      {
  ...
  if (!data || !data.pages || !Array.isArray(data.pages) || data.pages.length === 0) {
    return /* @__PURE__ */ React.createElement(AbsoluteFill, { style: { backgroundColor: "#ff0000" } }, /* @__PURE__ */ React.createElement("div", { style: {
      color: "white",
      fontSize: 24,
      display: "flex",
      alignItems: "center",
  ...
  return /* @__PURE__ */ React.createElement(AbsoluteFill, { style: outer }, data.pages.map((page, index) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(AbsoluteFill, { style: { backgroundColor: page.backgroundColor || "#ffffff" } }, elementsWithIds.map((element) => /* @__PURE__ */ React.createElement(
        Layer,
        {
          key: `element-${element.id}`,
          element,
...
const Root = () => {
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    {
      id: "VideoComposition",
      component: Composition_namespaceObject.VideoComposition,
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3169);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4937);
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3332);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7847);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(101);
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 5226)).then(({ StudioInternals }) => {
